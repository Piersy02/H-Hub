...
public class HackathonService {
    ...
    public Hackathon createHackathon(CreateHackathonDto dto, String organizerEmail) {
        ...
        //  ASSEGNAZIONE RUOLO CONTESTUALE
