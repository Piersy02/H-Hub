...
import com.ids.hhub.dto.inviteUserDto;// Nota: idealmente rinomina la classe
// in InviteUserDto (PascalCase)
...
@Tag(name = "Team Management", description = "API per la creazione " +
        "dei team, iscrizione agli hackathon e gestione inviti")
public class TeamController {
    ...
    @Operation(summary = "Iscrivi Team ad Hackathon", description = "Il Leader iscrive il proprio team a un Hackathon " +
            "specifico (usando i nomi). Verifica che l'hackathon sia in fase di iscrizione.")
    ...
    @Operation(summary = "Invia Invito (Leader)", description = "Il Leader invia un invito via " +
            "email a un altro utente per unirsi al team.")
    ...
    @Operation(summary = "I miei inviti in PENDING", description = "Visualizza tutti gli inviti ricevuti" +
            " dall'utente loggato che sono ancora in stato PENDING.")
    ...
    @Operation(summary = "Accetta Invito", description = "L'utente accetta di entrare nel team. " +
            "Se il team è già iscritto a un hackathon, verifica che le iscrizioni siano aperte.")
